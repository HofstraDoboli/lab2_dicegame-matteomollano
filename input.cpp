...
int main()
{
    ...
    string answer = "I entered 10 and the flag is false, and it displayed the value 10. But when I entered 4.5, \n it says the flag is still false and it extracts 4, and it continues the loop without accepting any other values."; // enter your answer in between ""
    ...
    answer = "I entered 10 and it set the fail flag to false, then I entered 4.5 and it set the fail flag to false, \n but it shows .5 in the buffer. For abc and a, it sets the fail flag to true and explains that it is not an integer."; // enter your answer in between ""
    ...
    */
    ...
    answer = "This code does the same thing as the code in question 4, however, when you enter abc, \n the error that is thrown by the code is caught using the try and catch block function. \n This stoi invalid argument error is then displayed to the screen, but the program does not terminate. \n It doesn't extract abc, so it skips a and 4, and it doesn't change the value stored in val."; // enter your answer in between ""
    ...
    for (int i = 0; i < array_values.size(); i++)
    {
        cout << "\n \n \tEnter the value " << array_values.at(i) << endl;
        cout << "\tEnter an int ";
        string s;
        getline(cin,s);
        ...
        if (s.length() > 0) 
        {
            cout << "\tError: This is not an integer.";
        }
    ...
    answer = "In order to validate integer values entered, the value 10 needs to be seen as an integer, \n while the rest of the values (4.5, abc, and a) must be flagged as not an integer and the program doesn't terminate."; // enter your answer in between ""
